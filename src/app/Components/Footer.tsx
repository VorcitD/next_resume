    ...
    return (
      <section className="h-60 pt-10 flex flex-col items-center justify-center">
        ...
        <div className="h-full flex flex-col justify-start items-center w-full ">
            <nav className="md:text-sm text-fontSecondary font-thin tracking-widest fill-fontPrimary font-serif w-full flex justify-end items-center ">
      ...
      <p className="text-sm md:text-md py-6 mb-3 font-thin font-sans text-fontSecondary" >Copyright 2024 © All Right Reserved by Victor Cavalcanti</p>
      </section>
    )
}